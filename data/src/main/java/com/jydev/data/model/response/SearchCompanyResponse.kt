package com.jydev.data.model.response
...
import com.jydev.data.model.dto.search.CompanyCellTypeDTO
import com.jydev.data.model.dto.search.HorizontalThemeCellTypeDTO
import com.jydev.data.model.dto.search.ReviewCellTypeDTO
import com.jydev.data.model.dto.search.SearchCellTypeDTO
        ...
        private fun getSearchCellType(cellType: String, data : JsonElement) : SearchCellTypeDTO {
            return when(cellType){
                ...
                SearchCellTypeDTO.CELL_TYPE_HORIZONTAL_THEME -> {
                    SearchCellTypeDTO.HorizontalTheme(gson.fromJson(data,
                        HorizontalThemeCellTypeDTO::class.java))
                }
